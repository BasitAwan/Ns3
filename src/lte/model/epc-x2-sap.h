...
public:
  ...
  virtual void SendStateReplicate (HandoverRequestParams params) = 0;
...
public:
  ...
  /**
   * Receive State Replication Request
   */

  virtual void RecvStateReplication (HandoverRequestParams params) = 0;
...
public:
  ...
  virtual void SendStateReplicate (HandoverRequestParams params);
...
template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendStateReplicate (HandoverRequestParams params)
{
  m_x2->DoSendStateReplicate (params);
}
...
public:
   ...
   * Receive State Replication Request
   */
  virtual void RecvStateReplication (HandoverRequestParams params);
...
template <class C>
void
EpcX2SpecificEpcX2SapUser<C>::RecvStateReplication (HandoverRequestParams params)
{
  m_rrc->DoRecvStateReplication (params);
}
...
{
  m_rrc->DoRecvStateAckReplication (params);
}

  virtual void  (HandoverRequestAckParams params) = 0;
